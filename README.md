...
## Summary
A passionate Software Architect, which over the yrss has specialized in web and platform solutions development, with a special focus on new technologies with a DevOps mind-set.
